...
- Practice tasks: Fizz Buzz, triangle patterns, anagram check, palindrome check, Calculator class with static methods, Student Profile class with static and instance members, and Encapsulation with private fields
